...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? FirstSlideWidget() : LoginWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: FirstSlideWidget.routeName,
          path: FirstSlideWidget.routePath,
          builder: (context, params) => FirstSlideWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: ChartFullWidget.routeName,
          path: ChartFullWidget.routePath,
        ...
        FFRoute(
          name: HeatmapWidget.routeName,
          path: HeatmapWidget.routePath,
          builder: (context, params) => HeatmapWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: DeveloperInfoWidget.routeName,
          path: DeveloperInfoWidget.routePath,
          builder: (context, params) => DeveloperInfoWidget(),
        ),
        FFRoute(
        ...
        pageBuilder: (context, state) {
          ...
          final child = appStateNotifier.loading
              ? Container(
                  ...
                  child: Center(
                    child: Image.asset(
                      'assets/images/himpawidLOGO.png',
                      width: 400.0,
                      height: 400.0,
                      fit: BoxFit.cover,
                    ),
