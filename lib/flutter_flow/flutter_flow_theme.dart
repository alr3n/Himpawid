...
abstract class FlutterFlowTheme {
  ...
  late Color limeSoft;
  late Color slate;
  late Color slateDeep;
  late Color slateMist;
...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF2F3E4A);
  late Color secondary = const Color(0xFF64798A);
  late Color tertiary = const Color(0xFF8FA3B2);
  late Color alternate = const Color(0xFFE9EDF0);
  late Color primaryText = const Color(0xFF171C20);
  late Color secondaryText = const Color(0xFF97A4AE);
  late Color primaryBackground = const Color(0xFFEDF0F2);
  late Color secondaryBackground = const Color(0xFFFFFFFF);
  late Color accent1 = const Color(0xFFDCF14A);
  late Color accent2 = const Color(0xFFAAB6BF);
  late Color accent3 = const Color(0xFFE0E5E9);
  late Color accent4 = const Color(0xFFF3F5F7);
  late Color success = const Color(0xFF04A24C);
  late Color warning = const Color(0xFFFCDC0C);
  late Color error = const Color(0xFFE21C3D);
  late Color info = const Color(0xFF64798A);

  late Color lineColor = const Color(0xFFE0E3E7);
  late Color lightCoral = const Color(0xFFEF767A);
  late Color azureWeb = const Color(0xFFEBFDFF);
  late Color raisinBlack = const Color(0xFF171C20);
  ...
  // Airly-inspired palette
  late Color lime = const Color(0xFFDCF14A);
  late Color limeSoft = const Color(0xFFEFF9B8);
  late Color slate = const Color(0xFF64798A);
  late Color slateDeep = const Color(0xFF31414D);
  late Color slateMist = const Color(0xFFB9C6D0);
}
