...
class FFAppState extends ChangeNotifier {
  ...
  // Empty when the last AQI fetch succeeded; otherwise a human-readable
  // reason it failed, so the UI can distinguish "still loading" / "failed"
  // from a genuine reading of 0.
  String _aqiError = '';
  String get aqiError => _aqiError;
  set aqiError(String value) {
    _aqiError = value;
  }
