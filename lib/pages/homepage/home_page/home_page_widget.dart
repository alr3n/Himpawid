...
class _HomePageWidgetState extends State<HomePageWidget>
  ...
  Widget build(BuildContext context) {
    ...
    final pieChartIndexPieChartColorsList = [
      FFAppState().gaugeColor,
      Colors.grey,
    ];
                        ...
                        children: [
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                MediaQuery.sizeOf(context).width * 0.08, 30.0, MediaQuery.sizeOf(context).width * 0.08, 0.0),
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                                      ...
                                      children: [
                                          ...
                                          child: Container(
                                            ...
                                            child: FlutterFlowPieChart(
                                              data: FFPieChartData(
                                                ...
                                                colors:
                                                    pieChartIndexPieChartColorsList,
                                                radius: [4.0],
                                                borderWidth: [0.0],
                                                borderColor: [
                                                  FlutterFlowTheme.of(context)
                                        ...
                                        Align(
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    MediaQuery.sizeOf(context).width * 0.1, 20.0, 0.0, 0.0),
                                            child: Text(
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  MediaQuery.sizeOf(context).width * 0.08, 0.0, MediaQuery.sizeOf(context).width * 0.08, 0.0),
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  MediaQuery.sizeOf(context).width * 0.08, 20.0, MediaQuery.sizeOf(context).width * 0.08, 0.0),
                              child: wrapWithModel(
                                model: _model.valueListItemModel,
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                MediaQuery.sizeOf(context).width * 0.08, 20.0, MediaQuery.sizeOf(context).width * 0.08, 30.0),
                            child: InkWell(
                              splashColor: Colors.transparent,
                              focusColor: Colors.transparent,
                              hoverColor: Colors.transparent,
                          ...
                          Align(
                            ...
                            child: Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  MediaQuery.sizeOf(context).width * 0.08, 20.0, MediaQuery.sizeOf(context).width * 0.08, 20.0),
                              child: Row(
                                mainAxisSize: MainAxisSize.max,
                                children: [
                                  Align(
                                      ...
                                      children: [
                                        Align(
                                          ...
                                          child: Padding(
                                            padding:
                                                EdgeInsetsDirectional.fromSTEB(
                                                    MediaQuery.sizeOf(context).width * 0.08, 0.0, 0.0, 0.0),
                                            child: ListView(
